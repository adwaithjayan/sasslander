...
import IntegrationsColumn from "@/components/integrationColums";
    ...
    return <section className='py-24 overflow-hidden'>
        <div className='container'>
            <div className='grid lg:grid-cols-2 items-center lg:gap-16'>
                ...
                <div
                    className="h-[400px] lg:h-[800px] lg:mt-0 grid md:grid-cols-2 gap-4 overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)] mt-8">
                    <IntegrationsColumn integrations={integrations}/>
                    <IntegrationsColumn integrations={integrations.slice().reverse()} className='hidden md:flex' reversed />
                </div>
            </div>
        </div>
    </section>;
